...
public class SimpleSpeciesType<I extends IIndividual> extends SpeciesType<I> {
	protected final Class<? extends I> individualClass;

	public SimpleSpeciesType(IRootContext<I> context, Class<? extends I> individualClass) {
		super(context);
	...
	public I create(CompoundTag compound) {
		try {
			...
			throw new IllegalStateException("The individual class of the root with the uid \'" + id + "\' doesn't has default constructor with the following parameter types (CompoundNBT). " +
				"Please create a constructor for these types or implement the create(CompoundNBT) method of the root.", e);
		} catch (InstantiationException | IllegalAccessException | InvocationTargetException e) {
			throw new IllegalStateException("Failed to instantiate an instance of the individual class of the root with the uid \'" + id + "\'.", e);
		}
	}
	...
	public I create(IGenome genome) {
		try {
			...
			throw new IllegalStateException("The individual class of the root with the uid \'" + id + "\' doesn't has default constructor with the following parameter types (IGenome). " +
	...
	public I create(IGenome genome, IGenome mate) {
		try {
			...
			throw new IllegalStateException("The individual class of the root with the uid \'" + id + "\' doesn't has default constructor with the following parameter types (IGenome,IGenome). " +
