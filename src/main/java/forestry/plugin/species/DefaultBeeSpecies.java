	...
	public static void register(IApicultureRegistration apiculture) {
		...
		apiculture.registerSpecies(ForestryBeeSpecies.FOREST, GENUS_HONEY, SPECIES_FOREST, true, new Color(0x19d0ec))
				...
				.setKaryotype(karyotype -> {
					karyotype.set(BeeChromosomes.POLLINATION, ForestryAlleles.POLLINATION_SLOWER);
					karyotype.set(BeeChromosomes.FERTILITY, ForestryAlleles.FERTILITY_3);
				});
		...
		apiculture.registerSpecies(ForestryBeeSpecies.COMMON, GENUS_HONEY, SPECIES_COMMON, true, new Color(0xb2b2b2))
				...
				.setKaryotype(karyotype -> {
					karyotype.set(BeeChromosomes.SPEED, ForestryAlleles.SPEED_SLOWER);
				})
		...
		apiculture.registerSpecies(ForestryBeeSpecies.CULTIVATED, GENUS_HONEY, SPECIES_CULTIVATED, true, new Color(0x5734ec))
				...
				.setKaryotype(karyotype -> {
					karyotype.set(BeeChromosomes.SPEED, ForestryAlleles.SPEED_FAST);
					karyotype.set(BeeChromosomes.LIFESPAN, ForestryAlleles.LIFESPAN_SHORTEST);
				})
				.addMutations(mutations -> {
		...
		apiculture.registerSpecies(ForestryBeeSpecies.NOBLE, GENUS_NOBLE, SPECIES_NOBLE, false, new Color(0xec9a19))
				...
				.setKaryotype(karyotype -> {
					karyotype.set(BeeChromosomes.SPEED, ForestryAlleles.SPEED_SLOWER);
					karyotype.set(BeeChromosomes.LIFESPAN, ForestryAlleles.LIFESPAN_SHORT);
					karyotype.set(BeeChromosomes.POLLINATION, ForestryAlleles.POLLINATION_SLOW);
				})
				.addMutations(mutations -> {
		...
		apiculture.registerSpecies(ForestryBeeSpecies.MAJESTIC, GENUS_NOBLE, SPECIES_MAJESTIC, true, new Color(0x7f0000))
				...
				.setKaryotype(karyotype -> {
					karyotype.set(BeeChromosomes.SPEED, ForestryAlleles.SPEED_NORMAL);
					karyotype.set(BeeChromosomes.LIFESPAN, ForestryAlleles.LIFESPAN_SHORTENED);
					karyotype.set(BeeChromosomes.FERTILITY, ForestryAlleles.FERTILITY_4);
				})
				.addMutations(mutations -> {
		...
		apiculture.registerSpecies(ForestryBeeSpecies.IMPERIAL, GENUS_NOBLE, SPECIES_IMPERIAL, false, new Color(0xa3e02f))
				...
				.setKaryotype(karyotype -> {
					karyotype.set(BeeChromosomes.SPEED, ForestryAlleles.SPEED_SLOWER);
					karyotype.set(BeeChromosomes.LIFESPAN, ForestryAlleles.LIFESPAN_NORMAL);
					karyotype.set(BeeChromosomes.EFFECT, ForestryAlleles.EFFECT_BEATIFIC);
				})
				.addMutations(mutations -> {
		...
		apiculture.registerSpecies(ForestryBeeSpecies.INDUSTRIOUS, GENUS_INDUSTRIOUS, SPECIES_INDUSTRIOUS, false, new Color(0xffffff))
				...
				.setKaryotype(karyotype -> {
					karyotype.set(BeeChromosomes.SPEED, ForestryAlleles.SPEED_SLOWER);
					karyotype.set(BeeChromosomes.LIFESPAN, ForestryAlleles.LIFESPAN_NORMAL);
					karyotype.set(BeeChromosomes.POLLINATION, ForestryAlleles.POLLINATION_FAST);
				})
				.addMutations(mutations -> {
		...
		apiculture.registerSpecies(ForestryBeeSpecies.STEADFAST, GENUS_HEROIC, SPECIES_STEADFAST, false, new Color(0x4d2b15))
				...
				.setKaryotype(karyotype -> {
					karyotype.set(BeeChromosomes.SPEED, ForestryAlleles.SPEED_SLOWER);
					karyotype.set(BeeChromosomes.LIFESPAN, ForestryAlleles.LIFESPAN_NORMAL);
					karyotype.set(BeeChromosomes.NEVER_SLEEPS, true);
					karyotype.set(BeeChromosomes.CAVE_DWELLING, true);
				})
				.setHasGlint(true);
		...
		apiculture.registerSpecies(ForestryBeeSpecies.VALIANT, GENUS_HEROIC, SPECIES_VALIANT, true, new Color(0x626bdd))
				...
				.setKaryotype(karyotype -> {
					karyotype.set(BeeChromosomes.SPEED, ForestryAlleles.SPEED_SLOW);
					karyotype.set(BeeChromosomes.LIFESPAN, ForestryAlleles.LIFESPAN_LONG);
					karyotype.set(BeeChromosomes.NEVER_SLEEPS, true);
					karyotype.set(BeeChromosomes.CAVE_DWELLING, true);
				});
		...
		apiculture.registerSpecies(ForestryBeeSpecies.HEROIC, GENUS_HEROIC, SPECIES_HEROIC, false, new Color(0xb3d5e4))
				...
				.setKaryotype(karyotype -> {
					...
					karyotype.set(BeeChromosomes.NEVER_SLEEPS, true);
					karyotype.set(BeeChromosomes.CAVE_DWELLING, true);
					karyotype.set(BeeChromosomes.EFFECT, ForestryAlleles.EFFECT_HEROIC);
				})
				.addMutations(mutations -> {
		...
		apiculture.registerSpecies(ForestryBeeSpecies.SINISTER, GENUS_INFERNAL, SPECIES_SINISTER, false, new Color(0xb3d5e4))
				...
				.setKaryotype(karyotype -> {
					karyotype.set(BeeChromosomes.SPEED, ForestryAlleles.SPEED_SLOWER);
					karyotype.set(BeeChromosomes.LIFESPAN, ForestryAlleles.LIFESPAN_NORMAL);
					karyotype.set(BeeChromosomes.EFFECT, ForestryAlleles.EFFECT_AGGRESSIVE);
				})
				.addMutations(mutations -> {
		...
		apiculture.registerSpecies(ForestryBeeSpecies.DEMONIC, GENUS_INFERNAL, SPECIES_DEMONIC, false, new Color(0xf4e400))
				...
				.setKaryotype(karyotype -> {
					karyotype.set(BeeChromosomes.SPEED, ForestryAlleles.SPEED_SLOWER);
					karyotype.set(BeeChromosomes.LIFESPAN, ForestryAlleles.LIFESPAN_LONGER);
					karyotype.set(BeeChromosomes.EFFECT, ForestryAlleles.EFFECT_IGNITION);
				})
				.addMutations(mutations -> {
		...
		apiculture.registerSpecies(ForestryBeeSpecies.AUSTERE, GENUS_AUSTERE, SPECIES_AUSTERE, false, new Color(0xfffac2))
				...
				.setKaryotype(karyotype -> {
					...
					karyotype.set(BeeChromosomes.LIFESPAN, ForestryAlleles.LIFESPAN_LONGER);
					karyotype.set(BeeChromosomes.TEMPERATURE_TOLERANCE, ForestryAlleles.TOLERANCE_DOWN_2);
					karyotype.set(BeeChromosomes.EFFECT, ForestryAlleles.EFFECT_CREEPER);
				})
				.addMutations(mutations -> {
		...
		apiculture.registerSpecies(ForestryBeeSpecies.EDENIC, GENUS_TROPICAL, SPECIES_EDENIC, false, new Color(0x393d0d))
				...
				.setKaryotype(karyotype -> {
					karyotype.set(BeeChromosomes.SPEED, ForestryAlleles.SPEED_SLOWEST);
					karyotype.set(BeeChromosomes.LIFESPAN, ForestryAlleles.LIFESPAN_LONGER);
					karyotype.set(BeeChromosomes.TEMPERATURE_TOLERANCE, ForestryAlleles.TOLERANCE_BOTH_2);
					karyotype.set(BeeChromosomes.EFFECT, ForestryAlleles.EFFECT_EXPLORATION);
				})
				.addMutations(mutations -> {
		...
		apiculture.registerSpecies(ForestryBeeSpecies.SPECTRAL, GENUS_END, SPECIES_SPECTRAL, true, new Color(0xa98bed))
				...
				.setKaryotype(karyotype -> {
					karyotype.set(BeeChromosomes.EFFECT, ForestryAlleles.EFFECT_REANIMATION);
				})
				.addMutations(mutations -> {
		...
		apiculture.registerSpecies(ForestryBeeSpecies.PHANTASMAL, GENUS_END, SPECIES_PHANTASMAL, false, new Color(0xcc00fa))
				...
				.setKaryotype(karyotype -> {
					karyotype.set(BeeChromosomes.SPEED, ForestryAlleles.SPEED_SLOWEST);
					karyotype.set(BeeChromosomes.LIFESPAN, ForestryAlleles.LIFESPAN_LONGEST);
					karyotype.set(BeeChromosomes.EFFECT, ForestryAlleles.EFFECT_REANIMATION);
				})
				.addMutations(mutations -> {
		...
		apiculture.registerSpecies(ForestryBeeSpecies.LEPORINE, GENUS_FESTIVE, SPECIES_LEPORINE, false, new Color(0xfeff8f))
				...
				.addProduct(() -> BEE_COMBS.stack(EnumHoneyComb.SILKY), 0.30f)
				.setKaryotype(karyotype -> {
					karyotype.set(BeeChromosomes.EFFECT, ForestryAlleles.EFFECT_FESTIVE_EASTER);
				})
				.addMutations(mutations -> {
		...
		apiculture.registerSpecies(ForestryBeeSpecies.MERRY, GENUS_FESTIVE, SPECIES_MERRY, false, new Color(0xffffff))
				...
				.setKaryotype(karyotype -> {
					karyotype.set(BeeChromosomes.NEVER_SLEEPS, true);
					karyotype.set(BeeChromosomes.EFFECT, ForestryAlleles.EFFECT_SNOWING);
				})
				.addMutations(mutations -> {
		...
		apiculture.registerSpecies(ForestryBeeSpecies.TIPSY, GENUS_FESTIVE, SPECIES_TIPSY, false, new Color(0xffffff))
				...
				.setKaryotype(karyotype -> {
					karyotype.set(BeeChromosomes.NEVER_SLEEPS, true);
					karyotype.set(BeeChromosomes.EFFECT, ForestryAlleles.EFFECT_DRUNKARD);
				})
				.addMutations(mutations -> {
		...
		apiculture.registerSpecies(ForestryBeeSpecies.TRICKY, GENUS_FESTIVE, SPECIES_TRICKY, false, new Color(0x49413B))
				...
				.setKaryotype(karyotype -> {
					karyotype.set(BeeChromosomes.NEVER_SLEEPS, true);
					karyotype.set(BeeChromosomes.TOLERATES_RAIN, true);
					karyotype.set(BeeChromosomes.FLOWER_TYPE, ForestryAlleles.FLOWER_TYPE_GOURD);
				})
				.addMutations(mutations -> {
		...
		apiculture.registerSpecies(ForestryBeeSpecies.PATRIOTIC, GENUS_FESTIVE, SPECIES_PATRIOTIC, true, new Color(0xb31942))
				...
				.setKaryotype(karyotype -> {
					karyotype.set(BeeChromosomes.TEMPERATURE_TOLERANCE, ForestryAlleles.TOLERANCE_UP_2);
					karyotype.set(BeeChromosomes.HUMIDITY_TOLERANCE, ForestryAlleles.TOLERANCE_UP_1);
					karyotype.set(BeeChromosomes.TERRITORY, ForestryAlleles.TERRITORY_LARGEST);
					// todo fireworks on 4th of July effect
					//karyotype.set(BeeChromosomes.EFFECT, ForestryAlleles.EFFECT_PATRIOTIC);
				})
				.addMutations(mutations -> {
		...
		apiculture.registerSpecies(ForestryBeeSpecies.FARMERLY, GENUS_AGRARIAN, SPECIES_FARMERLY, true, new Color(0xD39728))
				...
				.setKaryotype(karyotype -> {
					karyotype.set(BeeChromosomes.SPEED, ForestryAlleles.SPEED_SLOW);
					karyotype.set(BeeChromosomes.TERRITORY, ForestryAlleles.TERRITORY_LARGE);
				})
				.addMutations(mutations -> {
		...
		apiculture.registerSpecies(ForestryBeeSpecies.AGRARIAN, GENUS_AGRARIAN, SPECIES_AGRARIAN, true, new Color(0xFFCA75))
				...
				.setKaryotype(karyotype -> {
					karyotype.set(BeeChromosomes.SPEED, ForestryAlleles.SPEED_SLOW);
					karyotype.set(BeeChromosomes.HUMIDITY_TOLERANCE, ForestryAlleles.TOLERANCE_BOTH_2);
					karyotype.set(BeeChromosomes.EFFECT, ForestryAlleles.EFFECT_FERTILE);
					karyotype.set(BeeChromosomes.TERRITORY, ForestryAlleles.TERRITORY_LARGE);
				})
				.addMutations(mutations -> {
		...
		apiculture.registerSpecies(ForestryBeeSpecies.BOGGY, GENUS_BOGGY, SPECIES_BOGGY, true, new Color(0x698948))
				...
				.setKaryotype(karyotype -> {
					karyotype.set(BeeChromosomes.TOLERATES_RAIN, true);
					karyotype.set(BeeChromosomes.NEVER_SLEEPS, true);
					karyotype.set(BeeChromosomes.EFFECT, ForestryAlleles.EFFECT_MYCOPHILIC);
					karyotype.set(BeeChromosomes.TERRITORY, ForestryAlleles.TERRITORY_LARGER);
				})
				.addMutations(mutations -> {
		...
		apiculture.registerSpecies(ForestryBeeSpecies.SECLUDED, GENUS_MONASTIC, SPECIES_SECLUDED, true, new Color(0x7b6634))
				...
				.setKaryotype(karyotype -> {
					karyotype.set(BeeChromosomes.POLLINATION, ForestryAlleles.POLLINATION_FASTEST);
				})
				.addMutations(mutations -> {
		...
		apiculture.registerSpecies(ForestryBeeSpecies.HERMITIC, GENUS_MONASTIC, SPECIES_HERMITIC, false, new Color(0xffd46c))
				...
				.setKaryotype(karyotype -> {
					karyotype.set(BeeChromosomes.POLLINATION, ForestryAlleles.POLLINATION_FASTEST);
					karyotype.set(BeeChromosomes.EFFECT, ForestryAlleles.EFFECT_REPULSION);
				})
				.addMutations(mutations -> {
