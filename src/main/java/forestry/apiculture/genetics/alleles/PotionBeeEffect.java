...
public class PotionBeeEffect extends ThrottledBeeEffect {
	...
	public PotionBeeEffect(String name, boolean isDominant, MobEffect potion, int duration, int throttle, float chance) {
	...
	public PotionBeeEffect(String name, boolean isDominant, MobEffect potion, int duration) {
