...
public class Creeper extends ThrottledBeeEffect {
	...
	public Creeper() {
		super(ForestryConstants.MOD_ID, "creeper", 20, false, true);
	}
	...
	public IEffectData doEffectThrottled(IGenome genome, IEffectData storedData, IBeeHousing housing) {
		...
		for (Player player : players) {
			...
			int count = BeeManager.armorApiaristHelper.wearsItems(player, id(th), true);
			if (count > 3) {
