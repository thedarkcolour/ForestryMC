...
public class PotionBeeEffect extends ThrottledBeeEffect {
	...
	public PotionBeeEffect(String modId, String name, MobEffect potion, int duration, int throttle, float chance) {
		super(name, throttle, true, false);
		this.potion = potion;
	...
	public PotionBeeEffect(String modId, String name, MobEffect potion, int duration) {
		this(name, potion, duration, 200, 1.0f);
	}
