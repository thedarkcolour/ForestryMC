...
public class ApicultureMenuTypes {
	...
	public static final FeatureMenuType<ContainerMinecartBeehouse> BEEHOUSE_MINECART = REGISTRY.menuType(ContainerMinecartBeehouse::fromNetwork, "minecart_beehouse");
}
